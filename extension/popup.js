...
function renderPreview(product) {
  ...
  p.innerHTML=`<strong>${escapeHtml(product.title||'Product')}</strong><div class="stats">${product.images?.length||0} product images · ${product.specifications?.length||0} specs · ${product.variants?.length||0} variants</div>`;
}
