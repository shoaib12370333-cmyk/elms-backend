...
router.put('/:id', requireAuth, async (req, res) => {
  ...
  const updated = await updateListing(req.userId, id, { title, mainImage, images, sellPrice, markupPercent, currency, quantity, categoryId, ebayAccountId: destinationAccountId, marketplaceId: destinationMarketplaceId });
